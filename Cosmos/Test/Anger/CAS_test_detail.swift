...
struct CAS_test_detail: View{
    @Binding var selected_option :String
    var question : CASModel
    var guidance : String
    var body: some View{
        VStack(alignment: .leading){
            ...
            VStack(alignment: .leading){
                ...
                ForEach(question.optionsList){option in
                    CAS_test_option(selected_option: self.$selected_option, option: option)
                    Divider()
                }
            }
        }
...
struct CAS_test_option: View{
    @Binding var selected_option : String
    var option: CASOption
