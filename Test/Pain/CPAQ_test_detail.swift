...
struct CPAQ_test_detail: View{
    @Binding var selected_option :String
    var question : CPAQModel
    var guidance : String
    var body: some View{
        VStack(alignment: .leading){
            ...
            VStack(alignment: .leading){
                ...
                ForEach(question.optionsList){option in
                    CPAQ_test_option(selected_option: self.$selected_option, option: option)
                    Divider()
                }
            }
        }
...
struct CPAQ_test_option: View{
    @Binding var selected_option : String
    var option: CPAQOption
