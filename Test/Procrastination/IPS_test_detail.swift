...
struct IPS_test_detail: View{
    @Binding var selected_option :String
    var question : IPSModel
    var guidance : String
    var body: some View{
        VStack(alignment: .leading){
            ...
            Text(guidance)
                ...
                ForEach(question.optionsList){option in
                    IPS_test_option(selected_option: self.$selected_option, option: option)
                    Divider()
                }
        }
    }
...
struct IPS_test_option: View{
    @Binding var selected_option : String
    var option: IPSOption
